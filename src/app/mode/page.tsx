...
const page = (props: Props) => {
    return (
        <>
        <div className="flex flex-col items-center justify-center md:h-[600px] bg-homeBack px-4 py-12 sm:px-6 lg:px-8 h-[800px]">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        <div className="p-6 flex flex-col items-center justify-center h-full">
                            <div className="bg-[#8b5cf6] rounded-full p-3 mb-4">
                                <UserIcon className="h-8 w-8 text-white" />
                            </div>
                            <h2 className="text-2xl font-bold text-[#8b5cf6] mb-2">Local Multiplayer</h2>
                            <p className="text-gray-500 text-center">Gather your friends and compete in thrilling local matches.</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-2xl shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                        <div className="p-6 flex flex-col items-center justify-center h-full">
